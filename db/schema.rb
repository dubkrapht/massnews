...
ActiveRecord::Schema.define(version: 20170608203253) do
...
ActiveRecord::Schema.define(version: 20170606200656) do

  create_table "user_newsletters", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "user_id"
    t.bigint "newsletter_id"
  ...
  add_foreign_key "user_newsletters", "newsletters"
  add_foreign_key "user_newsletters", "users"
end
